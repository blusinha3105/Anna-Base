...
fs.writeFileSync('./bunker//sticker/data.exif', Buffer.concat([_, __, ___, ____]), function (err) {
console.log(err)
...
const chyt = "5511911942403@s.whatsapp.net";
const nit = "5511911942403@s.whatsapp.net";
const supre = "5511911942403@s.whatsapp.net";
